(() => {
  ...
  const translations = {
    es: {
      ...
      invitationKicker: 'INVITACIÓN', invitationHeading: 'Me haría mucha ilusión contar contigo',
      invitationText: 'Tras estos años de trabajo e investigación, será un placer compartir este momento contigo. Por favor, confirma tu asistencia a continuación.',
      openMaps: 'Abrir en Google Maps', streamLabel: 'RETRANSMISIÓN EN LÍNEA', joinStream: 'Unirse a la retransmisión',
    ...
    en: {
      ...
      invitationText: 'After these years of work and research, it would be a pleasure to share this important moment with you. Please confirm your attendance below.',
      openMaps: 'Open in Google Maps', streamLabel: 'ONLINE STREAMING', joinStream: 'Join the livestream',
